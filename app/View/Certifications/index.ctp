<asside class="left_asside">
	...
	<ul class="sidebar_nav">
		...
		<li class="active"><a href="/<?=$lang?>certifications"><?php echo __('Лицензии и сертификаты') ?></a></li>
	...
	<div class="content">
		<div id="wrapper">
			...
			<?php foreach($data as $item): ?>
				<li><a href="/img/certification/<?=$item['Certification']['img'] ?>" class="fancybox" rel="gallery"><img src="/img/certification/thumbs/<?=$item['Certification']['img'] ?>" alt=""></a></li>
			<?php endforeach ?>
			</ul>		
		</div>
	</div>
